  ...
  return (function (t) {
    ...
    8875: function (t, n, e) {
      ...
      (function (e, i) {
        (o = []),
          (r = i),
          (c = "function" === typeof r ? r.apply(n, o) : r),
        ...
        function t() {
          ...
          if (n && n.get !== t && document.currentScript)
            return document.currentScript;
          try {
            throw new Error();
          } catch (d) {
    ...
    b622: function (t, n, e) {
      ...
      t.exports = function (t) {
        return (
          (c(a, t) && (u || "string" == typeof a[t])) ||
            (u && c(s, t) ? (a[t] = s[t]) : (a[t] = p("Symbol." + t))),
          a[t]
        );
      };
    },
          ...
          return function (v, b, y, h) {
            for (
              var m,
                ...
                j = 0,
                L = h || u,
                T = n ? L(v, O) : e || l ? L(v, 0) : void 0;
              O > j;
              j++
            )
              if ((d || j in S) && ((m = S[j]), (g = w(m, j, x)), t))
                if (n) T[j] = g;
                else if (g)
                  switch (t) {
                    case 3:
    ...
    fb15: function (t, n, e) {
      "use strict";
      if ((e.r(n), "undefined" !== typeof window)) {
      ...
      e("159b"), e("b64b"), e("b0c0");
      var i = function () {
          var t = this,
            n = t.$createElement,
            e = t._self._c || n;
          return e("button", { staticClass: "cq-button" }, [
            t._v("my name is button"),
          ]);
        },
        u = [],
        f = { name: "CqButton" },
        a = f;
      e("735c");
      function s(t, n, e, r, o, c, i, u) {
        var f,
          a = "function" === typeof t ? t.options : t;
        if (
          (n && ((a.render = n), (a.staticRenderFns = e), (a._compiled = !0)),
          r && (a.functional = !0),
          c && (a._scopeId = "data-v-" + c),
          i
            ? ((f = function (t) {
                (t =
                  t ||
      ...
      var p = s(a, i, u, !1, null, null, null),
        l = p.exports,
        d = { button: l };
      function v(t) {
        Object.keys(d).forEach(function (n) {
          t.component(d[n].name, d[n]);
        });
      }
      var b = v;
      n["default"] = b;
...
//# sourceMappingURL=cq-vui.umd.min.js.map
